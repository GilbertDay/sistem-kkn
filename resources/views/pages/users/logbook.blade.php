<x-app-layout>
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addLogbookLabel">Tambah Logbook</h5>
                    ...
                    <form action="{{ route('addLogbook') }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="catatan" id="catatan" rows="3" />
                            </div>
                            <div class="mb-3">
        ...
        <!-- Modals for Editing and Deleting Logbook Entries -->
        @foreach($logbooks as $logbook)
            <!-- Modal Edit Logbook -->
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('editLogbook') }}" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="isi" class="form-label">Kegiatan</label>
                                    <input type="text" class="form-control" value="{{ $logbook->isi }}" name="isi" id="isi" rows="3" />
                                </div>
                                <div class="mb-3">
                                    <label for="catatan" class="form-label">Catatan</label>
                                    <input type="text" class="form-control" value="{{ $logbook->catatan }}" name="catatan" id="catatan" rows="3" />
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal" class="form-label">Tanggal Kegiatan</label>
