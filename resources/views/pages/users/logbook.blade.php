<x-app-layout>
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($logbook->status == 'proses')
                                            <span class="bg-yellow-300 text-black px-2 py-1 rounded">Proses</span>
        ...
        @foreach($logbooks as $logbook)
        <div class="modal fade" id="editLogbook-{{ $logbook->id }}" tabindex="-1" aria-labelledby="editLogbookLabel" aria-hidden="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('editLogbook') }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="kegiatan" class="form-label">Kegiatan</label>
                                <input type="text" class="form-control" value="{{ $logbook->kegiatan }}" name="kegiatan" id="kegiatan" />
                            </div>
                            <div class="mb-3">
                                <label for="catatan" class="form-label">catatan</label>
                                <input type="text" class="form-control" value="{{ $logbook->catatan }}" name="catatan" id="catatan" />
                            </div>
                            <div class="mb-3">
                                <label for="tanggal" class="form-label">Tanggal Kegiatan</label>
        ...
        <div class="modal fade" id="hapusLogbook-{{ $logbook->id }}" tabindex="-1" aria-labelledby="hapusLogbookLabel" aria-hidden="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
